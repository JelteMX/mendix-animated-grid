            ...
            new TerserPlugin({
                ...
                terserOptions: {
                    ...
                    output: {
                        comments: false,
                        beautify: false,
                        preamble: `/* Animated Grid || Version ${pkg.version} || Apache 2 LICENSE || Developer: ${pkg.author} || Please report any issues here: https://github.com/JelteMX/mendix-animated-grid/issues */\n`
                    },
                    toplevel: false,
                    nameCache: null,
                    ie8: false,
